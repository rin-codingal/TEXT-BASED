...
class RpsGame():
    def __init__(self):
        ...
        self.bg = pygame.image.load("4-5/M-23/RPS/background.jpg")
        self.r_btn = pygame.image.load("4-5/M-23/RPS/r_button.png").convert_alpha()
        self.p_btn = pygame.image.load("4-5/M-23/RPS/p_button.png").convert_alpha()
        self.s_btn = pygame.image.load("4-5/M-23/RPS/s_button.png").convert_alpha()

        self.choose_rock = pygame.image.load("4-5/M-23/RPS/rock.png").convert_alpha()
        self.choose_paper = pygame.image.load("4-5/M-23/RPS/paper.png").convert_alpha() 
        self.choose_scissors = pygame.image.load("4-5/M-23/RPS/scissors.png").convert_alpha()
        ...
        self.font = pygame.font.Font(('4-5/M-23/RPS/Splatch.ttf'), 90)
